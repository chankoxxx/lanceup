...
const initial: FormState = { experienceYears:"",technologies:"",employmentStatus:"",considerationTiming:"",desiredCompensation:"",name:"",prefecture:"",age:"",contactMethod:"line",email:"",phone:"",notes:"",japaneseAvailable:"yes",privacyConsent:false,attribution:{},website:"" };
const steps = [
  ...
  { title:"ご連絡先",description:"LINEまたはメールから、ご希望の連絡方法を選べます。",fields:["name","prefecture","age","contactMethod","email","phone","notes","japaneseAvailable"] },
